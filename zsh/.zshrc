...
export PATH="$DEV_DIR/go/bin:$HOME/.local/bin:$HOME/bin:$DEV_DIR/flutter/bin:$DEV_DIR/flutter/bin/cache/dart-sdk/bin:$ANDROID_STUDIO_HOME/bin:$HOME/.cargo/bin:$HOME/.cargo/env:$PATH"
